...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "checkbox-params.dsp");
		m->declare("name", "checkbox-params");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("checkbox-params");
		ui_interface->addCheckButton("c1", &fCheckbox0);

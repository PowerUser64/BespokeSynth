...
function(bespoke_obtain_llvm MODE)
   ...
   elseif(APPLE)
      if(_ARCH STREQUAL "arm64")
         ...
         message(FATAL_ERROR "BESPOKE_DOWNLOAD_LLVM: LLVM 18 does not offer downloads for x86_64 MacOS. Please use interpreter backend or install llvm18 at the system level (eg. homebrew).")
      endif()
   else()

...
NoteSwinger::NoteSwinger()
{
}

void NoteSwinger::Init()
{
...
void NoteSwinger::CreateUIControls()
{
   IDrawableModule::CreateUIControls();

   mDelaySlider = new FloatSlider(this, "delay", 4, 4, 100, 15, &mDelay, 0, 1, 4);
   mIndependentFromTransportCheckbox = new Checkbox(this, "write", 80, 3, &mIndependentFromTransport);
}

void NoteSwinger::DrawModule()
{
...
void NoteSwinger::CheckboxUpdated(Checkbox* checkbox, double time)
{
...
void NoteSwinger::OnTransportAdvanced(float amount)
{
   PROFILER(NoteSwinger);
...
void NoteSwinger::PlayNote(double time, int pitch, int velocity, int voiceIdx, ModulationParameters modulation)
{
   if (!mEnabled)
   {
...
void NoteSwinger::FloatSliderUpdated(FloatSlider* slider, float oldVal, double time)
{
}

void NoteSwinger::LoadLayout(const ofxJSONElement& moduleInfo)
{
...
void NoteSwinger::SetUpFromSaveData()
{
